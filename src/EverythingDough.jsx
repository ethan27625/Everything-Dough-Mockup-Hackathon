...
export default function EverythingDough() {
  return (
    <>
      ...
      <Footer />
      <ChatbotWidget />
      {/* Fixed CRM shortcut — bottom-left, visible on all screen sizes */}
      <Link
        to="/dashboard"
        style={{ position: 'fixed', bottom: '24px', left: '24px', zIndex: 9998 }}
        className="flex items-center gap-1.5 bg-[#C1272D] text-white text-xs font-bold px-3 py-2 rounded-full shadow-lg hover:bg-[#A01F23] transition-colors"
